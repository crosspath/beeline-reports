class UserFilesController < ApplicationController
  ...
  def create
    @user_file = UserFile.new(call_params)

    respond_to do |format|
      if @user_file.save
        format.html { redirect_to @user_file, notice: 'UserFile was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @user_file.update(call_params)
        format.html { redirect_to @user_file, notice: 'UserFile was successfully updated.' }
  ...
  def destroy
    @user_file.destroy
    respond_to do |format|
      format.html { redirect_to user_files_url, notice: 'UserFile was successfully destroyed.' }
  ...
  private
    ...
    def call_params
      params.require(:user_file).permit(:subscriber, :filename, :start_date, :end_date)
    end
end
